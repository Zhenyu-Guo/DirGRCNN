...
def load_data():
    ...
    with open(os.sep + "home" + os.sep + "dell" + os.sep + "GRGNN" + os.sep + "software" +
              os.sep + "pytorch_DGCNN" + os.sep + "data" + os.sep + "%s.txt" % cmd_args.data, 'r') as f:
        n_g = int(len(f.readline().strip()))
        for i in range(n_g):
